...
public class DealerAITest {
	...
	public void test1()  {
		...
		assertEquals("First card wrong", myhand.getCard(2).getValue(), swapcards.get(0).getValue());	
		assertEquals("Second card wrong", myhand.getCard(3).getValue(), swapcards.get(1).getValue());	
		assertEquals("Third card wrong", myhand.getCard(4).getValue(), swapcards.get(2).getValue());	
	...
	public void test2() {
		...
		assertEquals("Second Card Wrong", swapcards.get(0).getSuite(), myhand.getCard(4).getSuite());		
	}
	...
	public void test3() {
		...
		assertEquals("first swap card wrong", myhand.getCard(2).getSuite(), swapcards.get(0).getSuite());
		assertEquals("Second card wrong", myhand.getCard(3).getValue(), swapcards.get(1).getValue());	
		assertEquals("Third card wrong", myhand.getCard(4).getValue(), swapcards.get(2).getValue());
	}
	...
	public void test4() {
		...
		assertEquals("first swap card wrong", myhand.getCard(4).getSuite(), swapcards.get(0).getSuite());
